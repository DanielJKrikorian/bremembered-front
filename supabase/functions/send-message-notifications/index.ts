        ...
        html: `
          ...
          <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="${senderInfo.type === 'couple' ? 'https://app.bremembered.io/vendor-dashboard/messages' : 'https://bremembered.io/profile?tab=messages'}" style="background: linear-gradient(135deg, #f43f5e, #f59e0b); color: white; padding: 15px 30px; text-decoration: none; border-radius: 8px; font-weight: 600; display: inline-block; font-size: 16px;">
                Reply to Message
              </a>
            </div>
